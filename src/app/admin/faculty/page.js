        ...
        <div className="flex items-center justify-between">
          ...
          <Flex align="flex-start" gap="small" vertical  >
            <Link href="faculty/create">
              <Button type="primary" style={{ backgroundColor: '#2D427C', borderColor: '#2D427C', color: 'white' }}>เพิ่มคณะ</Button>
            </Link>
          </Flex>
        </div>
      </div>
        ...
        <table className="min-w-full">
          <thead className="bg-gray-100 ">
            <tr>
              ...
              <th scope="col" className="px-9 py-3 text-left text-base font-medium text-gray-500 uppercase tracking-wider">ชื่อคณะ</th>
